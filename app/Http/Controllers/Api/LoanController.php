        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    ...
                    new OA\Property(property: 'co_maker_ids', type: 'array', items: new OA\Items(type: 'integer'), example: [1], description: 'Omit to inherit the source loan\'s co-makers; send [] to drop them. Unlike POST /api/loans, each id is read as a co-maker record id first and otherwise as a member (borrower) id, because the restructure form pre-fills the source loan\'s co-maker record ids alongside picked member ids.'),
                    new OA\Property(property: 'loan_product_id', type: 'integer', example: 1),
