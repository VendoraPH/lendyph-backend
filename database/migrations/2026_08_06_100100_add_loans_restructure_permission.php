...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Initiating a restructure is a loan officer's job, but destroying debt
        // is not: a restructure whose principal falls short of the source's
        // outstanding balance additionally requires `loans:write_off`, which
        // only admins hold.
        $roleGrants = [
            'super_admin' => $newPermissions,
            'admin' => $newPermissions,
            'loan_officer' => ['loans:restructure'],
        ];
